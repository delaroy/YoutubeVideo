...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
  ...
  private static final ListEntry[] ENTRIES = {
      new ListEntry("GooglePlay InAPP", "nn2IbTSYNzA", false),
      new ListEntry("Volley Login", "KU1osfgDOqU", false),
      new ListEntry("Android Weather App", "PLvPqrYVmSBHf_EvMa_zLchBm5dzqhlmwS", true)};
